    ...
    <main className="pt-24 px-8 pb-12">
      <header className="mb-10 max-w-6xl mx-auto">
        ...
        <p className="text-on-surface-variant font-medium">
          Welcome back, Julian. Your cognitive load is optimized for research today.
        </p>
      </header>
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-12 gap-6">
        ...
        <div className="col-span-12 md:col-span-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant/10">
            <div className="flex flex-col gap-4">
              ...
              <div>
                <p className="text-4xl font-headline font-black text-on-surface">3</p>
          ...
          <div className="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant/10">
            <div className="flex flex-col gap-4">
              ...
              <div>
                <p className="text-4xl font-headline font-black text-on-surface">12</p>
                <p className="text-[10px] uppercase text-on-surface-variant font-medium tracking-wider">
                  Tasks remaining
                </p>
              </div>
        ...
        {/* Load Analysis */}
        <div className="col-span-12 md:col-span-4 bg-surface-container-low p-6 rounded-xl border border-outline-variant/15 flex flex-col justify-between">
        ...
        <div className="col-span-12 md:col-span-4 space-y-6">
          ...
          <div className="space-y-3">
            {[
              ...
              <label
                key={i}
                className="flex items-center gap-4 bg-surface-container-lowest p-4 rounded-xl border border-outline-variant/5 hover:border-primary/20 transition-all cursor-pointer group"
              >
                <div className="w-6 h-6 rounded-md border-2 border-outline-variant/30 flex items-center justify-center">
                  {task.done && (
